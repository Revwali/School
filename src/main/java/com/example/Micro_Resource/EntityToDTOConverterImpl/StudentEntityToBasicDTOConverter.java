...
import com.example.Micro_Resource.Enums.StudentScope;
...
public class StudentEntityToBasicDTOConverter implements EntityToDTOConverter<Student,StudentDTO> {
    ...
    public Optional<StudentDTO> getDTOAsBasic(Student student, StudentScope studentScope) {
     ...
     */
    @Override
    public Optional<List<StudentDTO>> getAllDTOAsBasic(Iterator<Student> students,StudentScope studentScope) {
        ...
        if (students != null) {
            ...
            for (Student student : studentList) {
                list.add(this.getDTOAsBasic(student,studentScope).get());
            }
        }
